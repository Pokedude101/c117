...
chosen_drawing = quick_draw_data_set[random_no];
document.getElementById("sketch_to_draw").innerHTML = "Sketch to be Drawn: " + chosen_drawing;

console.log(random_no)
console.log(chosen_drawing)
...
function gotResults(error, results) {
    if (error) {
        ...
        document.getElementById('sketch').innerHTML = 'Drawing: ' + drawn_sketch;
        document.getElementById('confidence').innerHTML = 'Confidence: ' + Math.round(resul.confidence * 100) + '%';
